...
; Do not remove these lines. These are credits of the owners. - Monster
; ####################
...
:?*:/crc01::
{
	if((VehRequirement= 0) && !isPlayerInAnyVehicle())
	{
		AddChatMessage("{FF6347}* You must be in a vehicle to check the MDC for the CRC.")
		return
	}
...
:?*:/crc02::
{
	...
	showGameText("~b~~h~LOADING CORRECTIONAL REHABILITATION CODE SECTION 2...~n~~g~PLEASE WAIT", 2000, 5)
	Sleep, 2000
    ShowDialog(5, "Section 2. Class II Offenses", "OFFENSES`tPUNISHMENT`n{FFFFFF}(2)01. Possession of Miscellaneous Contraband`t{FF0000}21 Days ((50 minutes))`n{FFFFFF}(2)02. Bribery`t{FF0000}30-50 Days ((100-120 minutes))`n{FFFFFF}(2)03. Incitement to Riot`t{FF0000}80 Days ((120 minutes))`n{FFFFFF}(2)04. Interference with Restraints`t{FF0000}20 Days ((70 minutes))`n{FFFFFF}(2)05. Prostitution`t{FF0000}14 Days ((50 minutes))`n{FFFFFF}(2)06. Pandering / Pimping`t{FF0000}60 Days ((80 minutes))`n{FFFFFF}(2)07. Robbery`t{FF0000}5-14 Days ((20-50 minutes))`n{FFFFFF}(2)08. Lewd Acts`t{FF0000}7 Days ((25 minutes))`n{FFFFFF}(2)09. Sexual Intercourse`t{FF0000}14 Days ((50 minutes))`n{FFFFFF}(2)11. Possession of a Controlled Substance`t{FF0000}7 Days ((30 minutes))`n{FFFFFF}(2)12. Extortion`t{FF0000}25 Days ((60 minutes))`n{FFFFFF}(2)13. Provoking`t{FF0000}21 Days ((60 minutes))`n", "Close")
...
:?*:/crc04::
{
	...
	showGameText("~b~~h~LOADING CORRECTIONAL REHABILITATION CODE SECTION 4...~n~~g~PLEASE WAIT", 2000, 5)
	Sleep, 2000
    ShowDialog(5, "Section 4. Class IV Offenses", "OFFENSES`tPUNISHMENT`n{FFFFFF}(4)01. Undue Familiarity`t{FF0000}10 Days ((25 minutes))`n{FFFFFF}(4)02. Disturbing the Peace`t{FF0000}5 Days ((15 minutes))`n{FFFFFF}(4)03. Misuse of Commissary Items`t{FF0000}10 Days ((25 minutes))`n{FFFFFF}(4)04. Improper Use of Prepared or Served Food`t{FF0000}1 Day ((10 minutes))`n{FFFFFF}(4)05. Interference with Official Duties`t{FF0000}3 Days ((20 minutes))`n{FFFFFF}(4)06. Interference with Surveillance`t{FF0000}3 Days ((15 minutes))`n{FFFFFF}(4)07. Interference with Cell Operation & Visibility`t{FF0000}5 Days ((15 minutes))`n{FFFFFF}(4)08. Smoking inside buildings`t{FF0000}5 Days ((15 minutes))`n{FFFFFF}(4)09. Gambling`t{FF0000}10 Days ((25 minutes))`n{FFFFFF}(4)10. Misuse of Medications`t{FF0000}2 Days ((15 minutes))`n", "Close")
...
:?*:/gwc01::
{
	...
	showGameText("~b~~h~LOADING CORRECTIONAL ENHANCEMENT POLICIES (GWC) SECTION 5...~n~~g~PLEASE WAIT", 2000, 5)
	Sleep, 2000
    ShowDialog(5, "Section 5. Enhancement Policies (GWC)", "OFFENSES`tPUNISHMENT`n{FFFFFF}(1)01. Murder`t{FF0000}315 Days ((270 minutes))`n{FFFFFF}(1)02. Attempted Murder`t{FF0000}158 Days ((270 minutes))`n{FFFFFF}(1)03. Assault with a Deadly Weapon`t{FF0000}158 Days ((270 minutes))`n{FFFFFF}(1)04. Assault and Battery`t{FF0000}53 Days ((175 minutes))`n{FFFFFF}(1)05. Torture`t{FF0000}158 Days ((175 minutes))`n{FFFFFF}(1)05. Rape`t{FF0000}140 Days ((210 minutes))`n{FFFFFF}(1)06. Hostage Taking`t{FF0000}245 Days ((270 minutes))`n{FFFFFF}(2)07. Robbery`t{FF0000}9 Days ((35 minutes))`n{FFFFFF}(2)12. Extortion`t{FF0000}44 Days ((105 minutes))`n", "Close")
...
:?*:/gwc02::
{
	...
	showGameText("~b~~h~LOADING CORRECTIONAL ENHANCEMENT POLICIES (A&B) SECTION 5...~n~~g~PLEASE WAIT", 2000, 5)
	Sleep, 2000
    ShowDialog(5, "Section 5. Enhancement Policies (A&B)", "OFFENSES`tPUNISHMENT`n{FFFFFF}(1)01. Aiding and abetting to Murder`t{FF0000}90 Days ((120 minutes))`n{FFFFFF}(1)02. Aiding and abetting to Attempted Murder`t{FF0000}45 Days ((90 minutes))`n{FFFFFF}(1)03. Aiding and abetting to Assault with a Deadly Weapon`t{FF0000}20 Days ((58 minutes))`n{FFFFFF}(1)04. Aiding and abetting to Assault and Battery`t{FF0000}15 Days ((50 minutes))`n{FFFFFF}(1)05. Aiding and abetting to Torture`t{FF0000}45 Days ((50 minutes))`n{FFFFFF}(1)05. Aiding and abetting to Rape`t{FF0000}40 Days ((60 minutes))`n{FFFFFF}(1)06. Aiding and abetting to Hostage Taking`t{FF0000}70 Days ((120 minutes))`n{FFFFFF}(2)07. Aiding and abetting to Robbery`t{FF0000}3 Days ((10 minutes))`n{FFFFFF}(2)12. Aiding and abetting to Extortion`t{FF0000}13 Days ((30 minutes))`n", "Close")
